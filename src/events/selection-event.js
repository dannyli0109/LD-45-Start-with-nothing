class SelectionEvent {
    constructor(dialoguesTextArray, selectionsTextArray, { row = 2, col = 3, paddingX = 20, paddingY = 10, dialoguePortion = 0.5, buttonWidth = BUTTON_WIDTH, buttonHeight = BUTTON_HEIGHT, isIcon = false } = {}) {
